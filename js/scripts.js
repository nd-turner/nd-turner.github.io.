...
*/
//
// Scriptwindow.addEventListener('DOMContentLoaded', event => {
    ...
    // Add onclick functionality for "Experience" and "Education" selectors
    ...
    // Function to change content in the Experience_Education_Information container
